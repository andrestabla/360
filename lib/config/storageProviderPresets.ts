...
export const storageProviderPresets: StorageProviderPreset[] = [
  ...
  },
  {
    ...
    label: 'Cloudflare R2',
    icon: 'CloudArrowUp',
    description: 'Almacenamiento de objetos de Cloudflare (compatible con S3)',
    color: 'text-orange-500',
    bgColor: 'bg-orange-50',
    instructions: {
      title: 'Configurar Cloudflare R2',
      steps: [
        'Inicia sesión en el Dashboard de Cloudflare',
        'Ve a "R2" y crea un bucket o usa uno existente',
        'Crea un token de API de R2 con permisos de edición (R2 Edit)',
        'Copia el Access Key ID y el Secret Access Key',
        'Obtén el S3 API Endpoint de tu bucket o el Account ID',
      ],
      warning: 'Usa el endpoint específico de S3 API proporcionado por Cloudflare para la máxima compatibilidad.',
      links: [
        { label: 'Cloudflare R2 Dashboard', url: 'https://dash.cloudflare.com/?to=/:account/r2' },
        { label: 'Documentación R2 S3 API', url: 'https://developers.cloudflare.com/r2/api/s3/api/' },
      ],
    },
    fields: [
      { id: 'accessKeyId', label: 'Access Key ID', type: 'text', placeholder: 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', required: true },
      { id: 'secretAccessKey', label: 'Secret Access Key', type: 'password', placeholder: 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', required: true },
      { id: 'bucket', label: 'Bucket Name', type: 'text', placeholder: 'my-r2-bucket', required: true },
      { id: 'endpoint', label: 'S3 API Endpoint', type: 'text', placeholder: 'https://<account_id>.r2.cloudflarestorage.com', hint: 'URL base del endpoint S3 de Cloudflare R2', required: true },
      { id: 'region', label: 'Region (Opcional)', type: 'text', placeholder: 'auto', hint: 'Por defecto es "auto" para R2', required: false },
    ],
  },
];
