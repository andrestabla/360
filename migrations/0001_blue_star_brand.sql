...
--> statement-breakpoint
ALTER TABLE "organization_settings" ADD COLUMN "plan" varchar(50) DEFAULT 'ENTERPRISE' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_user_notes_user" ON "user_notes" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_user_notes_date" ON "user_notes" USING btree ("date");--> statement-breakpoint
CREATE INDEX "idx_user_notes_status" ON "user_notes" USING btree ("status");