...
const seedAttachments = ()=>{
    const convo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].conversations.find((c)=>c.type === 'dm');
    if (!convo) return console.log('No DM found to seed');
    console.log('Seeding attachments to conversation:', convo.id);
    // 1. Image Message
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].messages.push({
        id: 'MSG-IMG-TEST',
        tenant_id: 'T1',
...
function AppProvider({ children }) {
    ...
    const currentTenant = currentTenantId ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].tenants.find((t)=>t.id === currentTenantId) || null : null;
    ...
    const login = (role, tenantId, email)=>{
        if (role === 'superadmin') {
            ...
            if (email) {
                user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.find((u)=>u.tenantId === tenantId && u.email?.toLowerCase() === email.toLowerCase());
            }
            // 2. Fallback to Role-based simulation
            if (!user) {
                user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.find((u)=>u.tenantId === tenantId && (role === 'admin' ? u.level === 1 : u.level > 1));
            }
            if (user) {
    ...
    const impersonateUser = (userId, tenantId)=>{
        ...
        const targetUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.find((u)=>u.id === userId && u.tenantId === tenantId);
        if (targetUser) {
    ...
    const updateUser = (updates)=>{
        if (currentUser) {
            ...
            // Also update in DB
            const dbIdx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.findIndex((u)=>u.id === currentUser.id);
            if (dbIdx >= 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users[dbIdx] = updated;
    ...
    const createUnit = (data)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units.push(newUnit);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
    };
    const updateUnit = (id, updates)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units.findIndex((u)=>u.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units[idx],
                ...updates
            };
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
    ...
    const deleteUnit = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units.findIndex((u)=>u.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].units.splice(idx, 1);
        }
    };
    const updateLevelPermissions = (level, permissions)=>{
        ...
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].tenants.findIndex((t)=>t.id === currentTenantId);
        if (idx >= 0) {
            const tenant = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].tenants[idx];
    ...
    const adminCheckEmailUnique = (email)=>{
        return !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.some((u)=>u.email?.toLowerCase() === email.toLowerCase());
    };
    const adminCreateUser = (userData, options = {})=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.push(newUser);
        // Audit Log
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].platformAudit.unshift({
            id: `audit-${Date.now()}`,
    ...
    const adminUpdateUser = (userId, updates)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.findIndex((u)=>u.id === userId);
        if (idx >= 0) {
            const oldUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users[idx];
            // Audit Check
            const auditChanges = [];
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users[idx] = {
                ...oldUser,
                ...updates
            };
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
    ...
    const adminDeleteUser = (userId)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.findIndex((u)=>u.id === userId);
        if (idx >= 0) {
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users[idx];
            // Integrity Check: Prevent deleting last admin
            if (user.level === 1 && user.status !== 'DELETED') {
                const otherAdmins = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users.filter((u)=>u.tenantId === user.tenantId && u.level === 1 && u.id !== userId && u.status === 'ACTIVE');
    ...
    const adminResendInvite = (userId)=>{
        ...
        if (idx >= 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].users[idx] = updated;
            // Email Log
            if (user.email) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].emailOutbox.unshift({
                    id: `email-${Date.now()}`,
    ...
    const adminDeletePost = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].posts.findIndex((p)=>p.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].posts.splice(idx, 1);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
            setForceUpdate((n)=>n + 1);
        }
    };
    const adminCreatePost = (postData)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].posts.unshift(newPost);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const adminUpdatePost = (id, updates)=>{
        const post = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].posts.find((p)=>p.id === id);
        if (post) {
    ...
    const adminCreateWorkflow = (data)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].workflowDefinitions.unshift(newWorkflow);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const createProjectFolder = (name, parentId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders.push(newFolder);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const createRepoFolder = (data)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders.push(newFolder);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const updateRepoFolder = (id, updates)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders.findIndex((f)=>f.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders[idx],
                ...updates,
                updatedAt: new Date().toISOString()
            };
    ...
    const deleteRepoFolder = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders.findIndex((f)=>f.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].repoFolders.splice(idx, 1);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
            setForceUpdate((n)=>n + 1);
        }
    };
    const uploadDoc = (docData)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.unshift(newDoc);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const updateDoc = (id, updates)=>{
        const doc = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.find((d)=>d.id === id);
        if (doc) {
    ...
    const deleteDoc = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.findIndex((d)=>d.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.splice(idx, 1);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
            setForceUpdate((n)=>n + 1);
        }
    };
    const toggleDocLike = (docId)=>{
        const doc = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.find((d)=>d.id === docId);
        if (doc) {
            if (doc.likes > 0) {
                doc.likes--;
            } else {
    ...
    const addDocComment = (docId, content)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].publicComments.push(newComment);
        const doc = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].docs.find((d)=>d.id === docId);
    ...
    const createProject = (projectData)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.unshift(newProject);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
    const updateProject = (id, updates)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.findIndex((p)=>p.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects[idx],
                ...updates,
                updatedAt: new Date().toISOString()
            };
    ...
    const deleteProject = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.findIndex((p)=>p.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.splice(idx, 1);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
            setForceUpdate((n)=>n + 1);
        }
    };
    const duplicateProject = (id)=>{
        const original = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.find((p)=>p.id === id);
    ...
    const updateProjectFolder = (id, updates)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders.findIndex((f)=>f.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders[idx],
                ...updates
            };
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
    ...
    const deleteProjectFolder = (id)=>{
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders.findIndex((f)=>f.id === id);
        if (idx >= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projects.forEach((p)=>{
                if (p.folderId === id) delete p.folderId;
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].projectFolders.splice(idx, 1);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
            setForceUpdate((n)=>n + 1);
        }
    };
    ...
    const updatePlatformSettings = (settings)=>{
        Object.assign(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].platformSettings, settings);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].save();
        setForceUpdate((n)=>n + 1);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5b18a26._.js.map