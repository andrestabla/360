...
function SlideOver() {
        ...
        "SlideOver.useEffect": ()=>{
            if (isSlideOpen) {
                ...
                if (slideData && slideData.id) {
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].contextChats[slideData.id]) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].contextChats[slideData.id] = [
                            {
                    ...
                    setChatMsgs(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].contextChats[slideData.id]);
                }
            }
        }
    }["SlideOver.useEffect"], [
    ...
    const sendContextMessage = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].contextChats[slideData.id].push(newMsg);
        setChatMsgs([
            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].contextChats[slideData.id]
        ]);
        setChatInput('');
    ...
    const renderDetail = ()=>{
        ...
        if (slideType === 'doc') {
            const comments = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DB"].publicComments.filter((c)=>c.docId === id) || [];
